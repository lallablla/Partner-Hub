...
import MeetingNotesSection from "../components/sections/MeetingNotesSection";

type Tab = "tasks" | "partner" | "resources" | "ai" | "sales" | "notes";
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h2 className="text-xl sm:text-2xl font-black text-foreground">
                마시떡 피자설기 <span className="text-blue-400">온라인 런칭</span> 플랜
              </h2>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        {activeTab === "notes" && (
          <MeetingNotesSection isPartner={isPartnerMode} />
        )}
